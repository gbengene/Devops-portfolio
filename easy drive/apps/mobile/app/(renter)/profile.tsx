/**
 * Renter Profile — Placeholder Screen
 *
 * Design spec: DESIGN_SYSTEM.md Section 4 — Renter Tab Bar (Profile tab)
...
export default function RenterProfile() {
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.subtitle}>Account, documents, and payment — coming soon</Text>
    </View>
  )
}
